...
main(int argc, char **argv) {
	...
	// Fix for laptop 1920x1200, remove
        int i;
        for (i = 0; i < number_of_monitors; i++) {
	    if ( monitors[i].height == 1200 ) {
		    imlib_blend_image_onto_image(buffer, 0, 0+96, 0, background_image_width, background_image_height, monitors[i].x, monitors[i].y, monitors[i].width+212, monitors[i].height);
	    }else {
